...
import com.king.candycrus.Apppp.Companion.MAIN_ID
import com.king.candycrus.databinding.ActivityWebbbyBinding
...
class Webbby : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWebbbyBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWebbbyBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "godsofaurora.xyz/go.php?to=2&"
