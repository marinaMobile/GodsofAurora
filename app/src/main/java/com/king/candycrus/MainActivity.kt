...
import com.king.candycrus.Apppp.Companion.AF_DEV_KEY
import com.king.candycrus.Apppp.Companion.C1
import com.king.candycrus.Apppp.Companion.D1
import com.king.candycrus.Apppp.Companion.jsoupCheck
import com.king.candycrus.Apppp.Companion.linkAppsCheckPart1
import com.king.candycrus.Apppp.Companion.linkAppsCheckPart2
import com.king.candycrus.Apppp.Companion.linkFilterPart1
import com.king.candycrus.Apppp.Companion.linkFilterPart2
import com.king.candycrus.Apppp.Companion.odone
import com.king.candycrus.databinding.ActivityMainBinding
import com.king.candycrus.game.Gamee
...
class MainActivity : AppCompatActivity() {
    ...
    private suspend fun mover(){
        ...
        if (jsoup == jsoupCheck) {
            Intent(applicationContext, Gamee::class.java).also { startActivity(it) }
        } else {
            Intent(applicationContext, Webbby::class.java).also { startActivity(it) }
        }
        finish()
    }
